...
function AuthPage({ mode }) {
  ...
  return (
    <div className="min-h-screen bg-parchment px-5 py-10">
      ...
      <div className="mx-auto w-full max-w-md rounded-2xl border border-mutedline border-l-4 border-l-sage bg-card p-8 shadow-cafe-lg">
